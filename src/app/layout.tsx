...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'ExcelFormula.AI' }],
  creator: 'ExcelFormula.AI',
  publisher: 'ExcelFormula.AI',
  robots: 'index, follow',
  openGraph: {
    title: 'Free Excel AI Formula Generator - No Signup (Instant)',
    description: 'The best free AI tool to write Excel formulas. Convert English to Excel formulas, VLOOKUP, IF functions, and Google Sheets scripts instantly.',
    url: 'https://excelformula.ai',
    siteName: 'ExcelFormula.AI',
    type: 'website',
    locale: 'en_US',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Free Excel AI Formula Generator - No Signup (Instant)',
    description: 'The best free AI tool to write Excel formulas. Convert English to Excel formulas, VLOOKUP, IF functions, and Google Sheets scripts instantly.',
    creator: '@excelformulaai',
    images: ['https://excelformula.ai/og-image.png'],
  },
  alternates: {
    canonical: 'https://excelformula.ai',
  },
