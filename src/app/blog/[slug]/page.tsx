...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: post.tags,
    alternates: {
      canonical: `https://www.aiexcelformula.com/blog/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.excerpt,
...
export default function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  // Article structured data for rich snippets in Google
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://www.aiexcelformula.com/blog/${post.slug}`,
    },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Blog',
        item: 'https://www.aiexcelformula.com/blog',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: post.title,
        item: `https://www.aiexcelformula.com/blog/${post.slug}`,
      },
    ],
  }
