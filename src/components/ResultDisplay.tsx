...
const CopyButton = memo(({ 
  ...
  <button
    onClick={onClick}
    className={`flex items-center gap-2 px-4 py-2 rounded-md font-medium transition-all duration-200 transform-gpu focus-visible-ring ${
      copySuccess
...
const FeedbackButton = memo(({ 
  ...
  return (
    <button
      ...
      className={`p-2 rounded-md transition-colors transform-gpu hover:scale-110 focus-visible-ring ${
        isActive
...
function ResultDisplay({ 
  ...
  onCopy,
  platform 
}: ResultDisplayProps & { platform?: Platform }) {
      ...
      <div className="w-full max-w-4xl mx-auto mt-6 bg-white rounded-lg shadow-lg border border-gray-200 p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-semibold text-gray-900">Generated Formula</h3>
